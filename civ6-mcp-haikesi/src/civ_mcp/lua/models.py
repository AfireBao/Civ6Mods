...
@dataclass
class CivReligionBeliefs:
    """One civ's pantheon + founded religion tenets (read-only snapshot)."""

    player_id: int
    civ_name: str = ""
    leader_name: str = ""
    pantheon_type: str | None = None
    pantheon_name: str | None = None
    religion_type: str | None = None
    religion_name: str | None = None
    beliefs: list[ReligionBeliefOption] = field(default_factory=list)
