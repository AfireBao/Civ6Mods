...
AI_LLM_DESCRIPTIONS: dict[str, str] = {
    ...
    "NW_AI_CULTURAL_BARRIER": (
        "Tourism generated by other civilizations against this civilization -20%. "
        "Does not reduce this civilization's outgoing Tourism or remove already accumulated Tourism / Visiting Tourists."
    ),
}
...
def relic_timing_tag(
    ...
    *,
    ...
    if relic_type == "NW_AI_CULTURAL_BARRIER":
        return "【持续·其他文明对本国有效TOURISM-20%·仅文化胜利启用时入池】"
