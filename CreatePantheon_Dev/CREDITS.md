...
- **PENDING VERIFY (效果待测待查):** Divine Spark harbor GPP after v15 band flags (still suspect engine ×2 if LO+HI both live); Religious Settlements / God of Wine load-game devotion rescan may skip those powers (Bugbot). Do not treat GPP/housing/amenity as confirmed fixed until retested in a fresh game + save/load.
