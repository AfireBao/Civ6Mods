...
-- RII Patron Saint : Keep BBG's 20% Faith conversion and restore the vanilla extra promotion for Apostles/Warrior Monks trained in the city.
...
INSERT INTO GovernorPromotionModifiers (GovernorPromotionType, ModifierId) VALUES
    ...
    ('GOVERNOR_PROMOTION_CARDINAL_PATRON_SAINT', 'CARDINAL_PATRON_SAINT_PROMOTION');
