...
| 上传日期 | 描述 |
|----------|------|
| 2026-07-30 | **领袖专属海克斯分区与「爱之法庭」**：新增 `Haikesi_Relic_LeaderEligibility` 多领袖 OR 资格层，并在 UI 抽取与 Gameplay 授予两端校验；首张领袖专属卡 `爱之法庭` 权重 **300**，仅英格兰/法国埃莉诺与松迪亚塔·凯塔可选。持有后，巨作按所在城市区域获得额外产出：著作/遗物 **+1**，艺术品/文物 **+2**，音乐 **+4**；学院→科技、剧院广场→文化、港口/商业中心→金币、圣地→信仰、工业区→生产力、社区→食物。持有期间禁用安善的巨作额外科技值，并组合保留 BBG 等先加载模组已有的安善条件。 |
