...
| 2026-07-27 | **开发者模式调试调整**：暂时注释开发者模式人类玩家全图实时视野解锁；开发者模式下人类玩家开局金币一次性补至 **1000000**。 |
...
| 2026-07-27 | **侦察兵线海克斯调整**：`三犬司门` 改为首都获得 **3 个侦察兵**，并使侦察兵 **+1 移动力 / +1 视野**；新增 `草丛插眼`（前置三犬司门，侦察兵额外 **+2 视野**，进攻 **-10**、防守 **+15**，权重 **100**）。 |
| 2026-07-27 | **血色契约海克斯叠层**：`德古拉` 更名为 `血色契约：血裔`；新增 `血色契约：伯爵`（前置血裔，权重 **50**，吸血鬼 **+1 移动**、击杀回血、可建吸血鬼城堡）与 `血色契约：大公`（前置伯爵，权重 **25**，吸血鬼城堡快速移动并赠送吸血鬼大公）。大公复用吸血鬼模型，拥有 2 射程远程攻击、5% 击杀转化、专属晋升树与透明底蝙蝠单位图标。 |
